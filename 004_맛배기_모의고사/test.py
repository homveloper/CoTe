...
test_cases = [
    ...
    {
        "name": "테스트케이스 1",
        "input": [1, 2, 3,4,5],  # 리스트 = solution([1, 2, 3])으로 호출
        "expected": [1],
    },
    {
        "name": "테스트케이스 2",
        "input": [1,3,2,4,2],  # 리스트 = solution([3, 2, 1])으로 호출
        "expected": [1, 2, 3],
    },
]

from solution import solution
from solution import simpler_solution
...
if __name__ == "__main__":
    ...
    run_tests(simpler_solution, test_cases)
