...
test_cases = [
    ...
    {
        "name": "테스트케이스 1",
        "input": (['i', 'drink', 'water'], ['want', 'to'], ['i', 'want', 'to', 'drink', 'water']),  # 리스트 = solution(['i', 'drink', 'water'], ['want', 'to', 'drink', 'water'], ['i', 'want', 'to', 'drink', 'water'])으로 호출
        "expected": 'Yes',
    },
    {
        "name": "테스트케이스 2",
        "input": (['i', 'water', 'drink'], ['want', 'to'], ['i', 'want', 'to', 'drink', 'water']),  # 리스트 = solution(['i', 'drink', 'water'], ['want', 'to', 'drink', 'water'], ['i', 'want', 'to', 'drink', 'water'])으로 호출
        "expected": 'No',
    },
    # 아래에 추가
]
